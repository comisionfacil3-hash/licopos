...
export default function SistemaPausadoPage() {
  ...
  const contactarWhatsApp = () => {
    window.open('https://wa.me/59179662811?text=Hola, mi sucursal está pausada y necesito ayuda', '_blank')
  }
    ...
    <div className="min-h-screen bg-gradient-to-br from-orange-500 to-amber-600 flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl shadow-xl w-full max-w-md p-8 text-center">
        ...
        <p className="text-gray-600 mb-6">
          El acceso a tu sucursal ha sido suspendido temporalmente. Por favor, contacta con el administrador para regularizar tu situación.
        </p>

        {/* Información de contacto */}
        <div className="bg-gray-50 rounded-xl p-4 mb-6">
          <p className="text-sm text-gray-500 mb-2">Contacta al administrador:</p>
          <p className="text-lg font-semibold text-gray-900">📞 79662811</p>
        </div>
